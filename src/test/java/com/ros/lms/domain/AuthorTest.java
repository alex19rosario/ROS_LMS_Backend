...
class AuthorTest {
    ...
    void testGettersAndSetters() {
        ...
        books.add(new Book(9780007136556L, "The Lord of the Rings", 'Y'));
        author.setBooks(books);

        assertNotNull(author.getBooks());
        assertEquals(1, author.getBooks().size());
        assertEquals("The Lord of the Rings", author.getBooks().get(0).getTitle());
    }
    ...
    void testConstructors() {
        ...
        List<Book> books = List.of(
                new Book(9780007136556L, "The Lord of the Rings", 'Y'),
                new Book(9780261102354L, "The Hobbit", 'Y')
        );
    ...
    void testBooksManagement() {
        ...
        author.getBooks().add(new Book(9780261102354L, "The Hobbit", 'Y'));
    ...
    void testSetBooksToNull() {
        List<Book> books = List.of(new Book(9780007136556L, "The Lord of the Rings", 'Y'));
        author.setBooks(books);
        assertNotNull(author.getBooks());
